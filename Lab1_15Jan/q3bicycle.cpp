...
//glLineWidth(10.0);
glBegin(GL_LINES);
    glVertex2f(treeRootx,treeRooty-100);
    glVertex2f(treeRootx + 100,treeRooty-200);

    glVertex2f(treeRootx,treeRooty-200);
    glVertex2f(treeRootx + 100,treeRooty-300);
