...
Color insideColor = {0.0, 0.0, 1.0}; // fill inside with white color
...
void disp(){
	...
	// ScanLineSeedAlgoStackBased(); // fill the inside using Flood Fill algorithm - stack Based
	ScanLineSeedAlgoRecursionBased(centreX, centreY); // fill the inside using Flood Fill algorithm - recursion Based
    glFlush();
}
